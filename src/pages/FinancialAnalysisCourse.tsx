            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
              ...
              <div className="space-y-6">
                {exercises.map((exercise) => (
                  <div key={exercise.id} className="border border-gray-700 rounded-lg p-4 hover:border-green-500/50 transition-all duration-300">
                    <h4 className="font-medium text-gray-100 mb-3">{exercise.text}</h4>
                    ...
                    <div className="pt-3 border-t border-gray-700">
                      <p className="text-sm text-green-400">正确答案: {String.fromCharCode(65 + exercise.correctAnswer)}</p>
